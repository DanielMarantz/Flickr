package com.flickr.assessment.flickrassessment.di.scope;
 ...
 * in this case we will initial component at the Activity level, so the the component will be alive within an Activity.
